...
class Logger internal constructor() {
    companion object {
        ...
        fun printJsonRequest(
            ...
            val requestBody =
                LINE_SEPARATOR + "Body:" + LINE_SEPARATOR + bodyToString(
                    request
                )
        ...
        fun printJsonResponse(
            ...
            val responseBody =
                LINE_SEPARATOR + "Body:" + LINE_SEPARATOR + getJsonString(
                    bodyString
                )
        ...
        private fun getRequest(
            ...
            return message.split(LINE_SEPARATOR!!.toRegex())
                .toTypedArray()
            //        String message;
//        String header
...
//        return message.split(LINE_SEPARATOR);
        ...
        private fun getResponse(
            ...
            val message: String
            message = "ResultFilter is Successful: $isSuccessful"
            return message.split(LINE_SEPARATOR!!.toRegex())
                .toTypedArray()
            //        String message;
//        boolean loggableHeader = level == Level.HEADERS || level == Level.BASIC;
//        message = ("ResultFilter is Successful: " + isSuccessful + DOUBLE_SEPARATOR + "Status Code: " +
...
//        return message.split(LINE_SEPARATOR);
        ...
        private fun dotHeaders(header: String): String {
            val headers =
                header.split(LINE_SEPARATOR!!.toRegex())
                    .toTypedArray()
